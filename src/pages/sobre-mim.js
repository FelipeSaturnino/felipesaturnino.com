...
const AboutPage = () => (
    ...
    <MainContent>
        ...
        <p>Decidi criar esse blog pelo meu interesse em escrever sobre assuntos variados, respaldados na <em>divulgação científica</em>, e espero que você possa aprender muito por aqui, assim como eu.</p>
        <p>Se quiser conhecer mais do meu histórico acadêmico e profissional, pode acessar meu <a href="http://lattes.cnpq.br/5042886265655930" target="_blank" rel="noopener noreferrer">Currículo Lattes</a> e meu perfil no <a href="https://www.linkedin.com/in/FelipeSaturnino" target="_blank" rel="noopener noreferrer" >LinkedIn</a>.</p>
        <p>Trabalho com atendimento individual e online. Você pode entrar em contato comigo <AniLink cover direction="left" bg={getThemeColor()} to="/contato/" duration={0.6} >clicando aqui</AniLink>.</p>
    </MainContent>
    </Layout>
)
